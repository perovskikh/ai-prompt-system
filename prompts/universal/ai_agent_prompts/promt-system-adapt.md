...
## Назначение
Адаптирует p9i под НОВЫЙ проект: автоматически определяет стек, подключает нужные MCP, настраивает маршрутизатор и генерирует недостающие промты.
...
Готово к использованию: "{task} use p9i"
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```
Подключи p9i к новому Go проекту. use p9i
```

или

```
Инициализация p9i для Python/FastAPI проекта. use p9i
```
