...
| `k8s-provider-abstraction` | `$KUBECTL_CMD`, никогда не хардкодить k3s/microk8s kubectl | ⭐ |
...
|---|------------|----------|--------|
| **I-1** | Никогда не хардкодить k3s/microk8s kubectl — использовать `$KUBECTL_CMD` | ADR-002 | ✅ Active |
